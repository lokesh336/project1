...
function Ad1 (){
    return(
        ...
        <Container fluid className="adscol" >
         <Row>
            <Col sm={6}>
            <h1 className="adshead">Featu<span className="adsround">red</span>  Ads </h1>
             <p className="prepara">Checkout these lattest Coo Ads From our members</p>
            </Col>
            <Col sm={6}>
            <Button className="adsbtn" variant="outline-danger">View All<ArrowCircleRightIcon/>
               </Button>
            </Col>
